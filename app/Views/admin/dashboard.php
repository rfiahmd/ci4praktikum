            ...
            <div class="col-lg-4">
                <div class="stats-box card bg-primary-div border-0 rounded-10 mb-4">
                    <div class="card-body p-4">
                        ...
                        <h3 class="body-font fw-bold fs-3 mb-1 text-white">$12,875 <sub class="fw-normal"><i class="ri-arrow-up-s-fill"></i> 10%</sub></h3>
                            ...
                            <li class="activity-item">
                                <a href="notification.html" class="text-decoration-none">
                                    ...
                                    <div class="activity-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/pdf.svg" alt="pdf">
                                            </div>
                            ...
                            <li class="activity-item">
                                <a href="notification.html" class="text-decoration-none">
                                    ...
                                    <div class="activity-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/notifications-1.jpg" alt="notifications">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                            ...
                            <li class="activity-item">
                                <a href="notification.html" class="text-decoration-none">
                                    ...
                                    <div class="activity-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/notifications-2.jpg" alt="notifications">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card-body p-4">
                <div class="d-sm-flex justify-content-between align-items-center">
                    <div class="flex-grow-1 mb-3 mb-sm-0">
                        ...
                        <h3 class="body-font fw-bold fs-24 mb-3">8.14k <sub class="text-gray-light fw-normal">Review</sub></h3>
                        <div class="d-flex align-items-center">
                            <div class="svg-warning me-2">
                                <i data-feather="star" style="width: 20px; height: 20px;"></i>
                            </div>
                            <p class="fw-semibold"><span class="text-body me-1">4.5</span> <span class="text-primary">+15.6%</span> From previous period</p>
                        </div>
                    </div>
                    <div class="flex-shrink-0">
                ...
                <ul class="ps-0 mb-0 list-unstyled max-h-198" data-simplebar>
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/user-1.jpg" class="rounded-circle wh-44" alt="user-1">
                                </div>
                            ...
                            <div class="d-flex align-items-center mt-2 mt-sm-0">
                                <span>$289.50</span>
                                <span class="bg-opacity-10 bg-primary fs-13 fw-semibold text-primary py-1 px-3 rounded-pill ms-10">15
                                    Orders</span>
                            </div>
                        </div>
                    </li>
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/user-2.jpg" class="rounded-circle wh-44" alt="user-2">
                                </div>
                                <div class="flex-grow-1 ms-10">
                            ...
                            <div class="d-flex align-items-center mt-2 mt-sm-0">
                                <span>$852.50</span>
                                <span class="bg-opacity-10 bg-primary fs-13 fw-semibold text-primary py-1 px-3 rounded-pill ms-10">17
                                    Orders</span>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/user-3.jpg" class="rounded-circle wh-44" alt="user-3">
                                </div>
                                <div class="flex-grow-1 ms-10">
                            ...
                            <div class="d-flex align-items-center mt-2 mt-sm-0">
                                <span>$456.50</span>
                                <span class="bg-opacity-10 bg-primary fs-13 fw-semibold text-primary py-1 px-3 rounded-pill ms-10">19
                                    Orders</span>
                            </div>
                        </div>
                    </li>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="product-details.html" class="d-flex align-items-center">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-1.jpg" class="wh-55 rounded-3" alt="product-1">
                            ...
                            <td>2024-12-19</td>
                            <td>
                                <span class="badge bg-primary bg-opacity-10 text-primary py-2 px-3 fw-semibold">Pending</span>
                            </td>
                            <td>5.0 (61 Votes)</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="product-details.html" class="d-flex align-items-center">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-2.jpg" class="wh-55 rounded-3" alt="product-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="product-details.html" class="d-flex align-items-center">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-3.jpg" class="wh-55 rounded-3" alt="product-3">
                            ...
                            <td>03-12-2024</td>
                            <td>
                                <span class="badge bg-success bg-opacity-10 text-success py-2 px-3 fw-semibold">Delivered</span>
                            </td>
                            <td>5.0 (61 votes)</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="product-details.html" class="d-flex align-items-center">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-4.jpg" class="wh-55 rounded-3" alt="product-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="product-details.html" class="d-flex align-items-center">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-5.jpg" class="wh-55 rounded-3" alt="product-5">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/user-4.jpg" class="rounded-circle wh-44" alt="user-4">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <td><a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8eebeffde7e0effcefe8effaa0e9e2ebfdb7b6cee4e1e7e2a0ede1e3">[email&#160;protected]</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/user-5.jpg" class="rounded-circle wh-44" alt="user-5">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                                <h4 class="fw-semibold fs-16 mb-0">Jordan Stevenson</h4>
                                                <span class="text-gray-light">@jstevenson5c</span>
                                    ...
                                    <td><a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f99580968c979ecd98a69a96959590978ab993969095d79a9694">[email&#160;protected]</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/user-6.jpg" class="rounded-circle wh-44" alt="user-6">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <td><a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="badcc8dbd4d18ddf8382fad0d5d3d694d9d5d7">[email&#160;protected]</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?= base_url('admin') ?>/assets/images/user-7.jpg" class="rounded-circle wh-44" alt="user-7">
                                            </div>
                                            <div class="flex-grow-1 ms-10">
                                    ...
                                    <td><a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="244145574d4a4556454245500a434841571d1c644e4b4d480a474b49">[email&#160;protected]</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                ...
                <ul class="ps-0 mb-0 list-unstyled max-h-406" data-simplebar>
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-6.jpg" class="rounded-3 wh-54" alt="product-6">
                                </div>
                                <div class="flex-grow-1 ms-10">
                    ...
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-7.jpg" class="rounded-3 wh-54" alt="product-7">
                                </div>
                                <div class="flex-grow-1 ms-10">
                    ...
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-8.jpg" class="rounded-3 wh-54" alt="product-8">
                                </div>
                                <div class="flex-grow-1 ms-10">
                    ...
                    <li class="border-bottom border-color-gray mb-3 pb-3">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-9.jpg" class="rounded-3 wh-54" alt="product-9">
                                </div>
                                <div class="flex-grow-1 ms-10">
                    ...
                    <li class="mb-1">
                        <div class="d-sm-flex justify-content-between align-content-center">
                            <a href="product-details.html" class="d-flex align-items-center text-decoration-none">
                                <div class="flex-shrink-0">
                                    <img src="<?= base_url('admin') ?>/assets/images/product-10.jpg" class="rounded-3 wh-54" alt="product-10">
                                </div>
                                <div class="flex-grow-1 ms-10">
