...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        ...
        <!-- content -->
        <form class="row g-3 needs-validation" action="/mahasiswa/<?= $mahasiswa['id']; ?>/update" method="post" novalidate>
            <?= csrf_field(); ?>
            ...
            <div class="col-md-8">
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <input type="text" name="nama" class="form-control h-58 ps-5" id="validationCustom01" value="<?= old('nama', $mahasiswa['nama']); ?>" required>
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <input name="nim" type="text" class="form-control h-58 ps-5" value="<?= old('nim', $mahasiswa['nim']); ?>" id="validationCustom03" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <input name="no_telepon" type="text" class="form-control h-58 ps-5" value="<?= old('nim', $mahasiswa['no_telepon']); ?>" id="validationCustomTelepon" placeholder="08xxxxxxxxxxxx"  required>
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <input name="alamat" type="text" class="form-control h-58 ps-5" value="<?= old('nim', $mahasiswa['alamat']); ?>" id="validationCustom05" placeholder="Masukkan alamat Anda...." required>
                        <div class="invalid-feedback">
            ...
            <div class="col-md-4">
                <div class="col-md-12" style="display: flex; justify-content: center; align-items: center; height: 45vh; margin-top: 30px; margin-bottom: -10px">
                    <div class="cardd">
                        <div class="imagesss">
                            <img class="imgg" id="imgContainer"  <img src="<?= !empty($mahasiswa['foto']) && file_exists(FCPATH . 'uploads/foto/' . $mahasiswa['foto']) ? base_url('uploads/foto/' . $mahasiswa['foto']) : base_url('assets/uploadImg/upload.jpg') ?>" alt="Foto Mahasiswa" width="400">
                            <p class="imgName"></p>
                        </div>
                        <label class="labell" for="inputGambar">
                            <span class="tmbl">Pilih Foto Profil</span>
                        </label>
                        <input class="inputt" name="foto" type="file" id="inputGambar" accept="image/*">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="position-relative">
                    <select name="jurusan_id" class="form-select form-control h-58 ps-5" id="validationCustom06" required>
            ...
            <div class="col-md-6">
                ...
                <div class="position-relative">
                    <select name="jenis_kelamin" class="form-select form-control h-58 ps-5" id="validationCustom06" required>
                        <option selected disabled value="">Pilih...</option>
